...
class _Step4ScopeOfWorkState extends State<Step4ScopeOfWork> {
  ...
  SignScopeOfWork get _scope => widget.draft.scopeOfWork;
  ...
  void _toggleScope(SignScopeType type, bool selected) {
    setState(() {
      if (selected) {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                for (final type in SignScopeType.values)
                  AppChip(
                    label: type.label,
            ...
            if (_scope.selectedScopes.contains(SignScopeType.others)) ...[
