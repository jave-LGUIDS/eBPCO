...
/// Terminal confirmation screen shown after Step 10's Submit Application
/// is pressed — sits outside the numbered 10-step flow, matching how
...
class SignApplicationSubmittedScreen extends StatelessWidget {
  final String referenceNumber;
  final DateTime submissionDate;
  final String relatedBuildingPermitNumber;
  final String relatedBuildingPermitStatus;

  const SignApplicationSubmittedScreen({
    super.key,
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your Sign Permit application has been submitted for '
