...
import 'steps/step5_sign_information.dart';
import 'steps/step6_required_documents.dart';
...
/// Sign Permit application wizard — a full 10-step flow based on the
/// official Sign Permit form (Boxes 1–9), completely separate from every
/// other permit in this app: its own model ([SignPermitDraft]), its own
/// provider ([SignPermitProvider]), and its own step widgets.
...
/// step content differs from the strict 9-step canonical shape — see
/// `sign_permit_model.dart`'s top doc-comment for the mapping.
class SignPermitWizardScreen extends StatefulWidget {
...
class _SignPermitWizardScreenState extends State<SignPermitWizardScreen> {
  ...
  static const implementedStepCount = 10;

  static const List<_StepMeta> _stepMeta = [
    _StepMeta(
      title: 'Permit Information',
      subtitle:
          'Provide the related Building Permit reference for this sign project.',
    ),
    _StepMeta(
    ...
    _StepMeta(
      ...
      subtitle: 'Provide the location where the sign will be installed.',
    ),
    _StepMeta(
      title: 'Scope of Work',
      subtitle: 'Select the project scope covered by the Sign Permit.',
    ),
    _StepMeta(
      title: 'Sign Information',
      subtitle: 'Provide the sign display, installation, and size details.',
    ),
    _StepMeta(
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the licensed professional responsible for the sign plans.',
    ),
    _StepMeta(
      title: 'Full-Time Inspector / Supervisor',
      subtitle: 'Provide the professional supervising the sign installation.',
    ),
    _StepMeta(
    ...
    _StepMeta(
      ...
      subtitle: 'Review the Sign Permit application before submission.',
    ),
  ];
  ...
  void _goToStep(int step) {
    ...
    context.read<SignPermitProvider>().goToStep(step);
  ...
  void _handleSaveDraft() {
    context.read<SignPermitProvider>().saveAsDraft();
              ...
              Expanded(
                child: PageView(
                  ...
                  children: [
                    ...
                    Step5SignInformation(
                      formKey: _formKeys[4],
                      draft: _draft,
                      onChanged: _onDraftChanged,
                    ),
                    Step6RequiredDocuments(
                      formKey: _formKeys[5],
                      draft: _draft,
                      onChanged: _onDraftChanged,
                    ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Complete your Sign Permit application step by step.',
