...
/// Building Permit. The Application Number and Interior Design Permit
/// Number are never asked of the applicant — both are system-generated
/// at submission, matching every other permit workflow in this app. The
/// official form's separate "Permit Information" box is folded in here,
/// alongside Related Building Permit, exactly where every other
/// ancillary permit already keeps that reference.
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  InteriorApplicantAddress get _address => widget.draft.applicantAddress;
  InteriorProjectLocation get _location => widget.draft.projectLocation;
  InteriorRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Interior Design Permit is null and void unless '
              'accompanied by a related Building Permit. If it has not '
              'been approved yet, leave the status as "Pending."',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (interiorMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final number in interiorMockBuildingPermitNumbers)
                          ActionChip(
                            label: Text(number),
                            onPressed: () {
                              setState(() {
