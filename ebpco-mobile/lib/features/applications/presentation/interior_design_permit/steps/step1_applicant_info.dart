...
/// Step 1 — Applicant Information. Permit Type is fixed to "Interior
/// Design Permit" (not editable) since this wizard is only reached
/// through the Applications → Ancillary Permits → Interior card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  InteriorApplicantInfo get _applicant => widget.draft.applicant;
          ...
          children: [
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<InteriorOccupancyGroup>(
                    value: _applicant.occupancyGroup,
                    label: 'Use or Character of Occupancy *',
                    items: InteriorOccupancyGroup.values
                        .map(
                          (g) => DropdownMenuItem(
                            value: g,
                            child: Text(g.label),
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: interiorFormsOfOwnership
                          .map(
