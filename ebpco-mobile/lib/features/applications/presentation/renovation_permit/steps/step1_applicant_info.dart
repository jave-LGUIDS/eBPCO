...
/// Applications → Building Permit → Renovation card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  RenovationApplicantInfo get _applicant => widget.draft.applicant;
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            AppDropdown<RenovationApplicationType>(
              value: _applicant.applicationType,
              label: 'Application Type *',
              items: RenovationApplicationType.values
                  .map(
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: renovationFormsOfOwnership
                          .map(
