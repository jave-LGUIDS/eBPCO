...
/// (with an Edit shortcut back into each), plus the five certifications
/// required before the renovation application can be submitted.
...
class _Step8ReviewDeclarationState extends State<Step8ReviewDeclaration> {
  RenovationPermitDraft get _draft => widget.draft;
  RenovationReviewDeclaration get _review => widget.draft.reviewDeclaration;
  ...
  Widget build(BuildContext context) {
    ...
    final location = _draft.renovationLocation;
    ...
    final affectedAreasSummary = project.affectedAreas
        .map((a) => a.label)
        .join(', ');
          ...
          children: [
            ...
            _SummarySection(
              ...
              rows: [
                ...
                _SummaryRow('General Description', project.generalDescription),
                _SummaryRow(
                  'Areas Affected',
                  affectedAreasSummary.isEmpty
                      ? 'Not set'
            ...
            _SummarySection(
              ...
              rows: [
                ...
                _SummaryRow(
                  ...
                  '${building.totalExistingFloorArea} sq m',
                ),
                _SummaryRow(
                  'Area Affected by Renovation',
                  '${building.areaAffectedByRenovation} sq m',
                ),
                _SummaryRow('Lot Area', '${building.lotArea} sq m'),
                _SummaryRow(
                  'Estimated Renovation Cost',
                  '₱${building.estimatedRenovationCost}',
                ),
                _SummaryRow(
                  'Proposed Start Date',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  _DeclarationCheckbox(
                    value: _review.confirmsRenovationOfExistingStructure,
                    label:
                        'I confirm that this application is for renovation of an existing structure.',
                    onChanged: (v) => _toggle(
                      (val) =>
                          _review.confirmsRenovationOfExistingStructure = val,
                      v,
                    ),
                  ),
                  _DeclarationCheckbox(
                    value: _review.understandsAdditionalPermitsMayBeRequired,
                    label:
