...
/// Step 8 — Full-Time Inspector / Supervisor (Box 3). Kept as its own
/// step, separate from Step 7's Design Professional, as in the
/// Fencing/Sign Permits' equivalent steps. Offers a one-shot "use the
/// same information" checkbox — checking it copies the Design
/// Professional's values once; it is not kept in sync afterward.
...
class _Step8SupervisorState extends State<Step8Supervisor> {
  ...
  ExcavationProfessionals get _professionals => widget.draft.professionals;
  ExcavationProfessionalInfo get _supervisor => _professionals.supervisor;
          ...
          children: [
            const AppAlert(
              ...
              message:
                  ...
                  'charge of the excavation and ground preparation work.',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.md),
                  AppDropdown<ExcavationProfessionType>(
