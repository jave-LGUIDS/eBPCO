...
class _Step4ScopeOfWorkState extends State<Step4ScopeOfWork> {
  ...
  ExcavationScopeOfWork get _scope => widget.draft.scopeOfWork;
  ...
  void _toggleScope(ExcavationScopeType type, bool selected) {
    setState(() {
      if (selected) {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                for (final type in ExcavationScopeType.values)
                  AppChip(
                    label: type.label,
            ...
            if (_scope.selectedScopes.contains(ExcavationScopeType.others)) ...[
