...
/// Step 7 — Design Professional (Box 2). Kept as its own step (rather
/// than combined with the Supervisor step), as in the Fencing/Sign
/// Permits' equivalent steps.
...
class _Step7DesignProfessionalState extends State<Step7DesignProfessional> {
  ...
  ExcavationProfessionalInfo get _design => _professionals.designProfessional;
          ...
          children: [
            const AppAlert(
              ...
              message:
                  ...
                  'excavation and ground preparation plans.',
            ),
            ...
            const SizedBox(height: AppSpacing.md),
            DocumentUploadTile(
              label: 'Signed and Sealed Excavation Plans',
