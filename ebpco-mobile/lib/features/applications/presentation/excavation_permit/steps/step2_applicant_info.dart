...
/// Step 2 — Owner / Applicant Information (Box 1). Use or Character of
/// Occupancy is collected separately in Step 5 — see
/// `excavation_permit_model.dart`'s top doc-comment.
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: excavationFormsOfOwnership
                          .map(
