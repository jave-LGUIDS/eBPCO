...
/// Permit. The Application Number and Electrical Permit Number are never
/// asked of the applicant — both are system-generated at submission,
/// matching every other permit workflow in this app.
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  ElectricalApplicantAddress get _address => widget.draft.applicantAddress;
  ElectricalProjectLocation get _location => widget.draft.projectLocation;
  ElectricalRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Electrical Permit is invalid without a related Building '
              'Permit, unless it covers purely electrical work on an '
              'existing building.',
              ...
              child: Column(
                ...
                children: [
                  SwitchListTile.adaptive(
                    ...
                    value: _relatedPermit.isPurelyElectricalOnExistingBuilding,
                    onChanged: (v) {
                      setState(
                        () =>
                  ...
                  const SizedBox(height: AppSpacing.sm),
                  if (!_relatedPermit.isPurelyElectricalOnExistingBuilding) ...[
                  ...
                  AppTextField(
                    ...
                    label: _relatedPermit.isPurelyElectricalOnExistingBuilding ||
                        ...
                        : 'Building Permit Number',
                    hint: _relatedPermit.isPurelyElectricalOnExistingBuilding
                        ? 'Enter the existing building\'s Building Permit number.'
                        : (_relatedPermit.status ==
                                  RelatedBuildingPermitStatus.approved
                  ...
                  if (electricalMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
