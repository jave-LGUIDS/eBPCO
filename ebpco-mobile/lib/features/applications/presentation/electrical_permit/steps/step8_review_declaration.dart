...
/// (with an Edit shortcut back into each), plus the ten certifications
/// required before the electrical application can be submitted.
...
class _Step8ReviewDeclarationState extends State<Step8ReviewDeclaration> {
  ElectricalPermitDraft get _draft => widget.draft;
  ElectricalReviewDeclaration get _review => widget.draft.reviewDeclaration;
  ...
  Widget build(BuildContext context) {
    ...
    final contractorRequired = details.requiresElectricalContractor;
        ...
        child: Column(
          ...
          children: [
            ...
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  'Purely Electrical on Existing Building',
                  relatedPermit.isPurelyElectricalOnExistingBuilding
                      ? 'Yes'
                      : 'No',
                ),
            ...
            _SummarySection(
              ...
              rows: [
                ...
                _SummaryRow(
                  'Primary Scope',
                  scope.primaryScope?.label ?? 'Not set',
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  ...
                  details.occupancyGroup?.label ?? 'Not set',
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            ...
            const SizedBox(height: AppSpacing.md),
            _SummarySection(
              title: 'Electrical Load and Capacities',
              onEdit: () => widget.onEditStep(3),
              rows: [
                _SummaryRow(
                  'Total Connected Load',
                  '${details.totalConnectedLoadKva} kVA',
                ),
                _SummaryRow(
                  'Main Service',
                  '${details.mainServiceVoltage} V / '
                      '${details.mainServiceCurrentAmperes} A',
                ),
                _SummaryRow(
                  'Electrical Contractor Required',
                  contractorRequired ? 'Yes' : 'No',
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            ...
            _SummarySection(
              ...
              rows: [
                ...
                _SummaryRow(
                  'Base Electrical Documents',
                  '$baseDocsUploaded of 9 uploaded',
                ),
              ],
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  _DeclarationCheckbox(
                    value: _review.understandsContractorRequiredAtThreshold,
                    label:
