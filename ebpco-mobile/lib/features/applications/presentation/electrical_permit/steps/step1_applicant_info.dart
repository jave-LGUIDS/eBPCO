...
/// Applications → Ancillary Permits → Electrical card. Occupancy
/// classification is collected once, in Step 4's fuller "Type of
/// Occupancy or Use" section, rather than duplicated here.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  ElectricalApplicantInfo get _applicant => widget.draft.applicant;
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: electricalFormsOfOwnership
                          .map(
