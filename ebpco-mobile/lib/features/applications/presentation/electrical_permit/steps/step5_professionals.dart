...
/// Supervisor / Electrical Practitioner in Charge, and — only when the
/// 200A/230V threshold from Step 4 is met — the Electrical Contractor.
...
class _Step5ProfessionalsState extends State<Step5Professionals> {
  ...
  late final TextEditingController _pcabLicenseNumber;
  late final TextEditingController _electricalWorksClassification;
  late final TextEditingController _contractorContactNumber;
  ...
  void dispose() {
    ...
    _pcabLicenseNumber.dispose();
    _electricalWorksClassification.dispose();
    _contractorContactNumber.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final supervisor = _professionals.supervisor;
    final contractor = _professionals.contractor;
    final contractorRequired =
        widget.draft.installationDetails.requiresElectricalContractor;
    final showContractorSection =
        contractorRequired || _professionals.contractorVoluntarilyIndicated;
        ...
        child: Column(
          ...
          children: [
            const AppAlert(
              ...
              message:
                  'The Electrical Permit requires a licensed Professional '
                  'Electrical Engineer to sign and seal the plans, and a '
                  'licensed electrical practitioner to supervise the work.',
            ),
            ...
            AppCard(
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Profession: Professional Electrical Engineer',
            ...
            DocumentUploadTile(
              ...
              onRemove: () {
                setState(
                  () => _professionals.signedLoadCalculationsUpload = null,
                );
                widget.onChanged();
              },
            ),
            ...
            const SizedBox(height: AppSpacing.xl),
            Text(
              'Supervisor / Electrical Practitioner In Charge',
              ...
              AppCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.md),
                    AppDropdown<ElectricalProfessionType>(
                      value: supervisor.profession,
                      label: 'Profession *',
                      items: ElectricalProfessionType.values
                          .map(
                            (p) => DropdownMenuItem(
                              value: p,
                              child: Text(p.label),
            ...
            const SizedBox(height: AppSpacing.xl),
            Text('Electrical Contractor', style: AppTypography.cardTitle),
            ...
            if (showContractorSection) ...[
              ...
              AppCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                      controller: _electricalWorksClassification,
                      label: 'Electrical Works Classification *',
                      validator: (v) => contractorRequired
                          ? Validators.required(
                              v,
                              fieldLabel: 'Electrical works classification',
                            )
                          : null,
                      onChanged: (v) {
                        contractor.electricalWorksClassification = v;
                        widget.onChanged();
                      },
                    ),
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                      controller: _contractorContactNumber,
              ...
              DocumentUploadTile(
                ...
                allowReplace: true,
                onRemove: () {
                  setState(() => contractor.pcabLicenseUpload = null);
                  widget.onChanged();
                },
              ),
              const SizedBox(height: AppSpacing.md),
