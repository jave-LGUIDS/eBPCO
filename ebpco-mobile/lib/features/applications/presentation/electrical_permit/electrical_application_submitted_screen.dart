...
/// sits outside the numbered 9-step flow, matching how the other six
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status and the Electrical Contractor requirement prominently.
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Electrical Application Submitted!',
                  style: AppTypography.pageTitle,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: AppSpacing.md),
                Text(
                  'Your Electrical Permit application has been '
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _InfoRow(
                        ...
                        value: electricalContractorRequired
                            ? 'Required'
                            : 'Not Required',
                      ),
                      const SizedBox(height: AppSpacing.sm),
