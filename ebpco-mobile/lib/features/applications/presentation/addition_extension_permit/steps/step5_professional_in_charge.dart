...
/// The Structural Analysis upload is only required when Step 3/4
/// indicate structural involvement — reused (not duplicated) by Step 7's
/// "Structural Analysis and Design Calculations" checklist item.
...
class _Step5ProfessionalInChargeState
  ...
  Widget build(BuildContext context) {
    final requiresStructuralAnalysis = widget.draft.requiresStructuralAnalysis;
        ...
        child: Column(
          ...
          children: [
            const AppAlert(
              ...
              message:
                  'The addition/extension permit requires a licensed '
                  'Architect or Civil Engineer to supervise and inspect '
                  'the work.',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  AppDropdown<AdditionExtensionProfessionType>(
            ...
            DocumentUploadTile(
              label: 'Structural Analysis or Certification',
              isRequired: requiresStructuralAnalysis,
              statusLabel: requiresStructuralAnalysis
                  ? 'Required — structural work is involved'
                  : 'Not required for the selected addition details',
