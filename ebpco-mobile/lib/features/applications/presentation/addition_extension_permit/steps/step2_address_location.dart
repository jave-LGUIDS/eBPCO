...
/// Step 2 — Applicant Address & Addition / Extension Location. The
/// "Project location is the same as my address" toggle copies the
/// applicant address into the project location fields once at the moment
/// it's switched on; the copied values then stay independently editable.
/// The user-friendly "Addition / Extension Location" label maps
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  AdditionExtensionApplicantAddress get _address =>
      widget.draft.applicantAddress;
  AdditionExtensionLocation get _location => widget.draft.projectLocation;
