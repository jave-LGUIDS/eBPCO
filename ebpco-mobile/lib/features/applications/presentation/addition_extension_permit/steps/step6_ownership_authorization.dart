...
/// applicant is the registered owner of the property, and if not,
/// collects the representative's details, CTC information, and four
/// supporting uploads.
...
class _Step6OwnershipAuthorizationState
  ...
  AdditionExtensionConsentAuthorization get _consent =>
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppTextField(
                      ...
                      label: 'Owner / Representative Address *',
                      textCapitalization: TextCapitalization.words,
                      validator: (v) => Validators.required(
                        v,
                        fieldLabel: 'Owner or representative address',
                      ),
                      onChanged: (v) {
