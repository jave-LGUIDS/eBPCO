...
/// Step 2 — Applicant Address, Location of Construction & Related
/// Building Permit. The Application Number and Electronics Permit Number
/// are never asked of the applicant — both are system-generated at
/// submission, matching every other permit workflow in this app. The
/// official form's separate "Permit and Related Application Information"
/// box is folded in here, alongside Related Building Permit, exactly
/// where every other ancillary permit already keeps that reference.
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  // Location of construction controllers.
  ...
  ElectronicsApplicantAddress get _address => widget.draft.applicantAddress;
  ElectronicsProjectLocation get _location => widget.draft.projectLocation;
  ElectronicsRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Location of Construction', style: AppTypography.cardTitle),
            const SizedBox(height: AppSpacing.sm),
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
            ...
            Text(
              'This Electronics Permit is null and void unless accompanied '
              'by a related Building Permit. If it has not been approved '
              'yet, leave the status as "Pending."',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (electronicsMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final number
                            in electronicsMockBuildingPermitNumbers)
                          ActionChip(
                            label: Text(number),
                            onPressed: () {
                              setState(() {
