...
/// with a same-person toggle — matching every other permit's
/// Professionals step. Both roles are always a "Professional Electronics
/// Engineer" per the official form, shown as a locked info row (matching
/// the Architectural/Civil-Structural/Electrical/Mechanical Permits'
/// single-profession pattern), not a dropdown.
        ...
        child: Column(
          ...
          children: [
            const AppAlert(
              ...
              message:
                  'This section must be completed by the appropriate '
                  'licensed Professional Electronics Engineer responsible '
                  'for the plans, and by the professional supervising the '
                  'work.',
            ),
            ...
            AppCard(
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Profession: Professional Electronics Engineer',
              ...
              onUpload: () {
                setState(() {
                  _professionals.signedDesignCalculationsUpload =
                      createMockDocument('Signed Design Calculations');
                });
                widget.onChanged();
              },
              allowReplace: true,
