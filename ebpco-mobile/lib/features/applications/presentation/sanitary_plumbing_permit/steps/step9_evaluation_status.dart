...
/// ([SanitaryPermitDraft.derivedPermitStatus]), so this permit can never
...
class Step9EvaluationStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isInvalidWithoutBuildingPermit =
        derivedStatus == SanitaryPermitStatus.invalidWithoutBuildingPermit;
          ...
          children: [
            if (isInvalidWithoutBuildingPermit)
              const AppAlert(
                ...
                message:
                    'This Sanitary / Plumbing Permit cannot be valid or '
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final entry
                      in SanitaryEvaluationPermitStatus
                          .documentEvaluation
                          .entries) ...[
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final stage
                      in SanitaryEvaluationPermitStatus.progressStages) ...[
                    _StatusRow(label: stage, status: 'Pending'),
                    if (stage !=
                        SanitaryEvaluationPermitStatus.progressStages.last)
                      const SizedBox(height: AppSpacing.sm),
                  ],
                ],
              ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  _InfoRow(
                    label: 'Action Taken',
                    value: SanitaryEvaluationPermitStatus.actionTaken,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
                    label: 'Recommending Approval',
                    value: SanitaryEvaluationPermitStatus.recommendingApproval,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
                    label: 'Permit Issued By',
                    value: SanitaryEvaluationPermitStatus.permitIssuedBy,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
            ...
            AppCard(
              child: Row(
                ...
                children: [
                  Expanded(
                    child: _InfoRow(
                      label: 'Sanitary / Plumbing Permit Status',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final condition
                      in SanitaryEvaluationPermitStatus.permitConditions) ...[
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(
                    ...
                    if (condition !=
                        SanitaryEvaluationPermitStatus.permitConditions.last)
                      const SizedBox(height: AppSpacing.sm),
                  ],
                ],
              ),
