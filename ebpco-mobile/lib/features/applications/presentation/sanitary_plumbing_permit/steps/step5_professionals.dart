...
/// Step 5 — Sanitary / Plumbing Professionals: the Design Professional
/// and the Supervisor / Professional In Charge. Unlike the Architectural,
/// Civil / Structural, Electrical, and Mechanical Permits, the profession
/// is selectable (Sanitary Engineer or Master Plumber) for BOTH roles
/// rather than locked to a single profession — this permit's own spec
/// allows either license type to perform the work.
        ...
        child: Column(
          ...
          children: [
            const AppAlert(
              ...
              message:
                  'The Sanitary / Plumbing Permit requires a licensed '
                  'Sanitary Engineer or Master Plumber to sign and seal '
                  'the plans, and a licensed professional to supervise '
                  'the work.',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  AppDropdown<SanitaryProfessionType>(
              ...
              onUpload: () {
                setState(() {
                  _professionals.signedSealedPlansUpload = createMockDocument(
                    'Signed and Sealed Sanitary / Plumbing Plans',
                  );
                });
                widget.onChanged();
              },
            ...
            const SizedBox(height: AppSpacing.xl),
            Text(
              'Supervisor / Professional In Charge',
