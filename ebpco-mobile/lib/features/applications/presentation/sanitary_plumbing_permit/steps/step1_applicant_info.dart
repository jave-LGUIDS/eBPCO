...
/// Plumbing Permit" (not editable) since this wizard is only reached
/// through the Applications → Ancillary Permits → Sanitary / Plumbing
/// card. Occupancy is intentionally not collected here — it lives once,
/// in Step 3's "Use or Type of Occupancy" section.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  SanitaryApplicantInfo get _applicant => widget.draft.applicant;
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: sanitaryFormsOfOwnership
                          .map(
