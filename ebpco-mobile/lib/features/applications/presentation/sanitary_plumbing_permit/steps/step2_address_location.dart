...
/// Permit. The Application Number and Sanitary / Plumbing Permit Number
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  SanitaryApplicantAddress get _address => widget.draft.applicantAddress;
  SanitaryProjectLocation get _location => widget.draft.projectLocation;
  SanitaryRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Sanitary / Plumbing Permit is invalid without a '
              'related Building Permit. If it has not been approved yet, '
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (sanitaryMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final number in sanitaryMockBuildingPermitNumbers)
                          ActionChip(
                            label: Text(number),
                            onPressed: () {
                              setState(() {
