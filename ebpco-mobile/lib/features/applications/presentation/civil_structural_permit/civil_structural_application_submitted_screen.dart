...
/// sits outside the numbered 9-step flow, matching how the other five
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status prominently, since the Civil / Structural Permit is
/// invalid without one.
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Civil / Structural Application Submitted!',
                  style: AppTypography.pageTitle,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: AppSpacing.md),
                Text(
                  'Your Civil / Structural Permit application has been '
