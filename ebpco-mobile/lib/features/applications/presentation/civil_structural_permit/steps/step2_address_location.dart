...
/// Permit. The Application Number and Civil / Structural Permit Number
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  CivilStructuralApplicantAddress get _address => widget.draft.applicantAddress;
  CivilStructuralProjectLocation get _location => widget.draft.projectLocation;
  CivilStructuralRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Civil / Structural Permit is invalid without a related '
              'Building Permit. If it has not been approved yet, leave the '
              'status as "Pending."',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (civilStructuralMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final number
                            in civilStructuralMockBuildingPermitNumbers)
                          ActionChip(
                            label: Text(number),
                            onPressed: () {
                              setState(() {
