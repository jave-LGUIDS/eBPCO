...
/// scopes may apply to a single civil/structural project.
...
class _Step3ScopeOfWorkState extends State<Step3ScopeOfWork> {
  ...
  CivilStructuralScopeOfWork get _scope => widget.draft.scopeOfWork;
  ...
  void initState() {
    ...
    _proposedChanges = TextEditingController(
      text: _scope.proposedStructuralChanges,
    );
  ...
  void _toggleScope(CivilStructuralScopeType type, bool selected) {
    setState(() {
      if (selected) {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                for (final type in CivilStructuralScopeType.values)
                  AppChip(
                    label: type.label,
              ...
              child: Column(
                ...
                children: [
                  AppTextField(
                    ...
                    label: 'Civil / Structural Work Title *',
                    textCapitalization: TextCapitalization.sentences,
                    validator: (v) => Validators.required(
                      v,
                      fieldLabel: 'Civil / Structural work title',
                    ),
                    onChanged: (v) {
                      _scope.workTitle = v;
                      widget.onChanged();
                  ...
                  AppTextField(
                    ...
                    label: 'Existing Structural Condition *',
                    maxLines: 3,
                    textCapitalization: TextCapitalization.sentences,
                    validator: (v) => Validators.required(
                      v,
                      fieldLabel: 'Existing structural condition',
                    ),
                    onChanged: (v) {
                      _scope.existingStructuralCondition = v;
                      widget.onChanged();
                    },
                  ),
                  const SizedBox(height: AppSpacing.md),
                  AppTextField(
                    ...
                    label: 'Proposed Structural Changes *',
                    maxLines: 3,
                    textCapitalization: TextCapitalization.sentences,
                    validator: (v) => Validators.required(
                      v,
                      fieldLabel: 'Proposed structural changes',
                    ),
                    onChanged: (v) {
                      _scope.proposedStructuralChanges = v;
                      widget.onChanged();
                    },
                  ),
                  const SizedBox(height: AppSpacing.md),
