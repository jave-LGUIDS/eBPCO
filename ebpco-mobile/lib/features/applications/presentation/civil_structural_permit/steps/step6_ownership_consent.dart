...
/// Step 6 — Ownership & Consent: confirms whether the applicant is the
/// Building Owner, and separately whether the Building Owner is also the
/// registered Lot Owner. Hidden fields never block navigation, and
...
class _Step6OwnershipConsentState extends State<Step6OwnershipConsent> {
  ...
  CivilStructuralOwnershipConsent get _consent => widget.draft.ownershipConsent;
