...
/// ([CivilStructuralPermitDraft.derivedPermitStatus]), so this permit can
          ...
          children: [
            if (isInvalidWithoutBuildingPermit)
              const AppAlert(
                ...
                message:
                    'This Civil / Structural Permit cannot be valid or '
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  _InfoRow(
                    label: 'Action Taken',
                    value: CivilStructuralEvaluationPermitStatus.actionTaken,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
                  ...
                  _InfoRow(
                    ...
                    value: CivilStructuralEvaluationPermitStatus.permitIssuedBy,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
            ...
            AppCard(
              child: Row(
                ...
                children: [
                  Expanded(
                    child: _InfoRow(
                      label: 'Civil / Structural Permit Status',
