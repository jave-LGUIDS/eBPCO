...
/// Structural Permit" (not editable) since this wizard is only reached
/// through the Applications → Ancillary Permits → Civil / Structural card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  CivilStructuralApplicantInfo get _applicant => widget.draft.applicant;
          ...
          children: [
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<CivilStructuralOccupancyGroup>(
                    value: _applicant.occupancyGroup,
                    label: 'Use or Character of Occupancy *',
                    items: CivilStructuralOccupancyGroup.values
                        .map(
                          (g) => DropdownMenuItem(
                            value: g,
                            child: Text(g.label),
                  ...
                  if (_applicant.occupancyGroup ==
                      CivilStructuralOccupancyGroup.others) ...[
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: civilStructuralFormsOfOwnership
                          .map(
