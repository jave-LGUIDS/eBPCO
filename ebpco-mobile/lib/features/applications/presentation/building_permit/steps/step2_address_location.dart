...
/// Step 2 — Applicant Address & Construction Location. The "Use my address"
/// toggle copies the applicant address into the construction location
/// fields once at the moment it's switched on; the copied values then stay
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  // Construction location controllers.
  ...
  late final TextEditingController _locZipCode;

  ApplicantAddress get _address => widget.draft.applicantAddress;
  ConstructionLocation get _location => widget.draft.constructionLocation;
  ...
  void initState() {
    ...
    _locZipCode = TextEditingController(text: _location.zipCode);
  }
  ...
  void _handleUseSameAddressToggled(bool value) {
    setState(() {
      widget.draft.useApplicantAddressForConstruction = value;
      if (value) {
        widget.draft.copyApplicantAddressToConstruction();
        ...
        _locZipCode.text = _location.zipCode;
      }
    });
    widget.onChanged();
  }
              ...
              child: Column(
                ...
                children: [
                  SwitchListTile.adaptive(
                    ...
                    title: const Text(
                      'Use my address as the construction location.',
                    ),
                    value: widget.draft.useApplicantAddressForConstruction,
