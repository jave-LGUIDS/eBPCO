...
/// [_FixtureInventoryRow], a small self-contained widget that owns its
/// own controllers — updating one fixture's quantity never rebuilds or
/// erases any other fixture's entry.
...
class _FixtureInventoryRow extends StatefulWidget {
  final PlumbingFixtureEntry entry;
  final VoidCallback onChanged;
...
class _FixtureInventoryRowState extends State<_FixtureInventoryRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final isOthers = entry.type == PlumbingFixtureType.others;
