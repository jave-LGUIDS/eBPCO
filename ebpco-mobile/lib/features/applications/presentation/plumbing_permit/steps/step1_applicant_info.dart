...
/// Applications → Ancillary Permits → Plumbing card — a workflow that is
/// entirely separate from the combined Sanitary / Plumbing Permit card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  PlumbingApplicantInfo get _applicant => widget.draft.applicant;
          ...
          children: [
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<PlumbingOccupancyGroup>(
                    value: _applicant.occupancyGroup,
                    label: 'Use or Character of Occupancy *',
                    items: PlumbingOccupancyGroup.values
                        .map(
                          (g) => DropdownMenuItem(
                            value: g,
                            child: Text(g.label),
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: plumbingFormsOfOwnership
                          .map(
