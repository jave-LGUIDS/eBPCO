...
/// ([PlumbingPermitDraft.derivedPermitStatus]), so this permit can never
...
class Step9EvaluationStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isInvalidWithoutBuildingPermit =
        derivedStatus == PlumbingPermitStatus.invalidWithoutBuildingPermit;
          ...
          children: [
            if (isInvalidWithoutBuildingPermit)
              const AppAlert(
                ...
                message:
                    'This Plumbing Permit cannot be valid or issued until '
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final entry
                      in PlumbingEvaluationPermitStatus
                          .documentEvaluation
                          .entries) ...[
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final stage
                      in PlumbingEvaluationPermitStatus.progressStages) ...[
                    _StatusRow(label: stage, status: 'Pending'),
                    if (stage !=
                        PlumbingEvaluationPermitStatus.progressStages.last)
                      const SizedBox(height: AppSpacing.sm),
                  ],
                ],
              ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  _InfoRow(
                    label: 'Action Taken',
                    value: PlumbingEvaluationPermitStatus.actionTaken,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
                    label: 'Permit Issued By',
                    value: PlumbingEvaluationPermitStatus.permitIssuedBy,
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  for (final condition
                      in PlumbingEvaluationPermitStatus.permitConditions) ...[
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(
                    ...
                    if (condition !=
                        PlumbingEvaluationPermitStatus.permitConditions.last)
                      const SizedBox(height: AppSpacing.sm),
                  ],
                ],
              ),
