...
/// Permit. The Application Number and Plumbing Permit Number are never
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  PlumbingApplicantAddress get _address => widget.draft.applicantAddress;
  PlumbingProjectLocation get _location => widget.draft.projectLocation;
  PlumbingRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Plumbing Permit is invalid without a related Building '
              'Permit. If it has not been approved yet, leave the status '
              'as "Pending."',
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (plumbingMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final number in plumbingMockBuildingPermitNumbers)
                          ActionChip(
                            label: Text(number),
                            onPressed: () {
                              setState(() {
