...
/// sits outside the numbered 9-step flow, matching how the other nine
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status. Distinct from the Sanitary / Plumbing Permit's
/// submitted screen.
class PlumbingApplicationSubmittedScreen extends StatelessWidget {
  final String referenceNumber;
  final DateTime submissionDate;
  final String relatedBuildingPermitNumber;
  final String relatedBuildingPermitStatus;

  const PlumbingApplicationSubmittedScreen({
    super.key,
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Plumbing Application Submitted!',
                  style: AppTypography.pageTitle,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: AppSpacing.md),
                Text(
                  'Your Plumbing Permit application has been submitted '
                  'for initial review. You will be notified once the '
                  'Office of the Building Official completes the '
