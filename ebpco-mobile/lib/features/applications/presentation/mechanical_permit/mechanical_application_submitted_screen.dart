...
/// sits outside the numbered 9-step flow, matching how the other seven
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status and the Certificate of Operation status, which remains
/// its own separate, later process.
class MechanicalApplicationSubmittedScreen extends StatelessWidget {
  final String referenceNumber;
  final DateTime submissionDate;
  final String relatedBuildingPermitNumber;
  final String relatedBuildingPermitStatus;

  const MechanicalApplicationSubmittedScreen({
    super.key,
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Mechanical Application Submitted!',
                  style: AppTypography.pageTitle,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: AppSpacing.md),
                Text(
                  'Your Mechanical Permit application has been '
