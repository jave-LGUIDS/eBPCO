...
/// Applications → Ancillary Permits → Mechanical card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  MechanicalApplicantInfo get _applicant => widget.draft.applicant;
          ...
          children: [
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<MechanicalOccupancyGroup>(
                  ...
                  if (_applicant.occupancyGroup ==
                      MechanicalOccupancyGroup.others) ...[
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: mechanicalFormsOfOwnership
                          .map(
