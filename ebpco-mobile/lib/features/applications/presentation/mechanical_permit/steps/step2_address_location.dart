...
/// Permit. The Application Number and Mechanical Permit Number are never
...
class _Step2AddressLocationState extends State<Step2AddressLocation> {
  ...
  MechanicalApplicantAddress get _address => widget.draft.applicantAddress;
  MechanicalProjectLocation get _location => widget.draft.projectLocation;
  MechanicalRelatedBuildingPermit get _relatedPermit =>
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This Mechanical Permit is invalid without a related '
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  if (mechanicalMockBuildingPermitNumbers.isNotEmpty) ...[
                    const SizedBox(height: AppSpacing.sm),
                    Text(
