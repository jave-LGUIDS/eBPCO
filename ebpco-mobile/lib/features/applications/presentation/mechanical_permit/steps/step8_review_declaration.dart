...
/// (with an Edit shortcut back into each), plus the nine certifications
/// required before the mechanical application can be submitted.
...
class _Step8ReviewDeclarationState extends State<Step8ReviewDeclaration> {
  MechanicalPermitDraft get _draft => widget.draft;
  MechanicalReviewDeclaration get _review => widget.draft.reviewDeclaration;
        ...
        child: Column(
          ...
          children: [
            ...
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  ...
                  equipmentSummary.isEmpty ? 'Not set' : equipmentSummary,
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            _SummarySection(
              ...
              onEdit: () => widget.onEditStep(3),
              rows: [
                _SummaryRow('Equipment Location', details.equipmentLocation),
                _SummaryRow(
                  'Number of Equipment Units',
                  details.numberOfEquipmentUnits,
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  ...
                  '₱${details.totalEstimatedProjectCost}',
                ),
                _SummaryRow(
                  'Proposed Starting Date',
                  _formatDate(details.proposedStartDate),
                ),
                _SummaryRow(
                  'Expected Completion Date',
                  _formatDate(details.expectedCompletionDate),
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            ...
            _SummarySection(
              ...
              rows: [
                ...
                _SummaryRow(
                  ...
                  '$coreDocsUploaded of 8 uploaded',
                ),
              ],
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  _DeclarationCheckbox(
                    value: _review.understandsCertificateOfOperationRequired,
                    label:
