...
/// Applications → Building Permit → Demolition card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  DemolitionApplicantInfo get _applicant => widget.draft.applicant;
      ...
      child: FormScrollScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            AppCard(
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text('Demolition', style: AppTypography.bodyStrong),
                  ),
                ],
              ),
            ),
            ...
            Text(
              'Select the current use or character of occupancy of the '
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<DemolitionOccupancyGroup>(
                  ...
                  if (_applicant.occupancyGroup ==
                      DemolitionOccupancyGroup.others) ...[
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: demolitionFormsOfOwnership
                          .map(
