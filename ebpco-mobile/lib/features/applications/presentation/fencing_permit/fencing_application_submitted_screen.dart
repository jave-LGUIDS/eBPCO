...
/// Terminal confirmation screen shown after Step 9's Submit Application is
/// pressed — sits outside the numbered 9-step flow, matching how every
/// other permit wizard closes out its flow. Surfaces the related Building
/// Permit's status. Uses [FormScrollScaffold] (rather than an unwrapped
/// `Center`/`Column`) so this content scrolls instead of overflowing on
/// shorter Android viewports.
class FencingApplicationSubmittedScreen extends StatelessWidget {
  final String referenceNumber;
  final DateTime submissionDate;
  final String relatedBuildingPermitNumber;
  final String relatedBuildingPermitStatus;

  const FencingApplicationSubmittedScreen({
    super.key,
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your Fencing Permit application has been submitted for '
