...
/// Permit spec's explicit 9-step order. Offers a one-shot "use the same
/// information" checkbox rather than the same-person toggle used by most
/// other permits — checking it copies the Design Professional's values
/// once; it is not kept in sync afterward.
class Step6Supervisor extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final FencingPermitDraft draft;
  final VoidCallback onChanged;

  const Step6Supervisor({
    super.key,
  ...
  @override
  State<Step6Supervisor> createState() => _Step6SupervisorState();
}

class _Step6SupervisorState extends State<Step6Supervisor> {
  ...
  FencingProfessionals get _professionals => widget.draft.professionals;
  FencingProfessionalInfo get _supervisor => _professionals.supervisor;
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.md),
                  AppDropdown<FencingProfessionType>(
