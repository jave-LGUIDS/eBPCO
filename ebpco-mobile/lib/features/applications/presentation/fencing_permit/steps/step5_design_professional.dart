...
/// Professionals step) per the Fencing Permit spec's explicit 9-step
/// order.
class Step5DesignProfessional extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final FencingPermitDraft draft;
  final VoidCallback onChanged;

  const Step5DesignProfessional({
    super.key,
  ...
  @override
  State<Step5DesignProfessional> createState() =>
      _Step5DesignProfessionalState();
}

class _Step5DesignProfessionalState extends State<Step5DesignProfessional> {
  ...
  FencingProfessionalInfo get _design => _professionals.designProfessional;
          ...
          children: [
            const AppAlert(
              ...
              message:
                  ...
                  'Architect or Civil Engineer responsible for the '
                  'fencing plans.',
            ),
