...
/// sits outside the numbered 9-step flow, matching how the other four
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status prominently, since the Architectural Permit is invalid
/// without one.
          ...
          child: FormScrollScaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Architectural Application Submitted!',
                  style: AppTypography.pageTitle,
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: AppSpacing.md),
                Text(
                  'Your Architectural Permit application has been '
