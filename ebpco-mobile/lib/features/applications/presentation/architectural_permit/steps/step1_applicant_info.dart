...
/// Step 1 — Applicant Information. Permit Type is fixed to "Architectural
/// Permit" (not editable) since this wizard is only reached through the
/// Applications → Ancillary Permits → Architectural card.
...
class _Step1ApplicantInfoState extends State<Step1ApplicantInfo> {
  ...
  ArchitecturalApplicantInfo get _applicant => widget.draft.applicant;
          ...
          children: [
            ...
            AppCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  AppDropdown<ArchitecturalOccupancyGroup>(
                    value: _applicant.occupancyGroup,
                    label: 'Use or Character of Occupancy *',
                    items: ArchitecturalOccupancyGroup.values
                        .map(
                          (g) => DropdownMenuItem(
                            value: g,
                            child: Text(g.label),
                  ...
                  if (_applicant.occupancyGroup ==
                      ArchitecturalOccupancyGroup.others) ...[
                    const SizedBox(height: AppSpacing.md),
                    AppTextField(
                ...
                children: [
                  ...
                  if (_applicant.isOwnedByEnterprise) ...[
                    ...
                    AppDropdown<String>(
                      ...
                      items: architecturalFormsOfOwnership
                          .map(
