...
/// fills both roles, the Supervisor's own fields/uploads are never
/// populated — a read-only summary is shown instead, and Step 7 reads the
/// Design Architect's uploads for both roles in that case.
...
class _Step5ProfessionalsState extends State<Step5Professionals> {
  ...
  void initState() {
    super.initState();
    final design = _professionals.designArchitect;
        ...
        child: Column(
          ...
          children: [
            const AppAlert(
              ...
              message:
                  'The Architectural Permit requires a licensed Architect '
                  'to sign and seal the plans, and a licensed Architect to '
                  'supervise the work.',
            ),

            const SizedBox(height: AppSpacing.xl),
            Text('Design Architect', style: AppTypography.cardTitle),
            ...
            AppCard(
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text('Profession: Architect', style: AppTypography.bodyStrong),
                  ),
                ],
              ),
            ),
            ...
            const SizedBox(height: AppSpacing.xl),
            Text(
              'Supervisor / Architect In Charge',
            ...
            AppCard(
              child: SwitchListTile.adaptive(
                ...
                title: const Text(
                  'Is the Design Architect also the Supervisor / In-Charge?',
                ),
                value: _professionals.isSupervisorSameAsDesignArchitect,
                onChanged: (v) {
                  setState(() => _professionals.isSupervisorSameAsDesignArchitect = v);
                  widget.onChanged();
                },
              ),
            ),
            if (_professionals.isSupervisorSameAsDesignArchitect) ...[
              const SizedBox(height: AppSpacing.md),
              AppCard(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    Text('Same as Design Architect', style: AppTypography.bodyStrong),
                    const SizedBox(height: AppSpacing.sm),
