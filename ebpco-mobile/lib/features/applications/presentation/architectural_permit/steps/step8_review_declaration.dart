...
/// (with an Edit shortcut back into each), plus the seven certifications
/// required before the architectural application can be submitted.
...
class _Step8ReviewDeclarationState extends State<Step8ReviewDeclaration> {
  ArchitecturalPermitDraft get _draft => widget.draft;
  ArchitecturalReviewDeclaration get _review => widget.draft.reviewDeclaration;
  ...
  Widget build(BuildContext context) {
    ...
    final compliance = _draft.complianceDetails;
    ...
    final accessibilityDeclared = compliance.accessibility.values
        .where((s) => s != AccessibilityFacilityStatus.notApplicable)
        .length;
    final fireCodeDeclared = compliance.fireCode.values
        .where((s) => s != FireCodeFeatureStatus.notApplicable)
        .length;
        ...
        child: Column(
          ...
          children: [
            ...
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  ...
                  '$accessibilityDeclared of ${compliance.accessibility.length}',
                ),
                _SummaryRow(
                  'Fire Code Features Declared',
                  '$fireCodeDeclared of ${compliance.fireCode.length}',
                ),
                _SummaryRow(
                  'Building Footprint',
                  '${compliance.buildingFootprintPercentage}%',
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            ...
            _SummarySection(
              ...
              rows: [
                _SummaryRow(
                  'Design Architect Documents',
                  '$designDocsUploaded of 4 uploaded',
                ),
                _SummaryRow(
                  'Architectural Documents',
                  '$propertyDocsUploaded of 8 uploaded',
                ),
              ],
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  _DeclarationCheckbox(
                    value: _review.confirmsPlansPreparedByLicensedArchitect,
                    label:
                  ...
                  _DeclarationCheckbox(
                    value: _review.understandsAccessibilitySubjectToEvaluation,
                    label:
                  ...
                  _DeclarationCheckbox(
                    value: _review.understandsFireSafetySubjectToEvaluation,
                    label:
