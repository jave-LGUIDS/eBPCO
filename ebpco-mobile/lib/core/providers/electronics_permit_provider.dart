...
class ElectronicsPermitProvider extends ChangeNotifier {
  ...
  ElectronicsPermitDraft? get draft => _draft;
  int get currentStep => _currentStep;

  /// Whether there is an unsubmitted draft the wizard can resume into.
  bool get hasResumableDraft =>
      _draft != null && _draft!.status == ElectronicsPermitDraftStatus.draft;
  ...
  ElectronicsPermitDraft resumeOrStart() {
  ...
  ElectronicsPermitDraft startNew() {
    final draft = ElectronicsPermitDraft();
    _draft = draft;
    _currentStep = 0;
    return draft;
  }
